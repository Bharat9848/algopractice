 ...
 *     1 <= piles[i] <= 109
 *
 *     TODO Maths: did not work - find avg then work out the minimum by going to next no ..
 *     Do it by iterative approach from speed 1 to ... using binary search.
 */
class P875KokoEatingBananasNotDone {
    int minEatingSpeed(int[] piles, int h){
        return 0;
    }

    private int binarySearchNextOrSameIndex(int[] piles, int avg) {
        return 0;
    }
