 ...
 * solution:
 * at a particular position if I know what is min jump is required to reach that position and from here I can to jump to all the indexes that comes in the range of i to i+arr[i]. minJum[n-1] = min(minJump[i] +1 for some i which have (i + arr[i])>=n-1)
 */
